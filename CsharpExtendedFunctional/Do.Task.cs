...
namespace CsharpExtendedFunctional
{
    public static partial class DoExtensions
    {
        ...
        public static async Task<T> Do<T>(this T self, Func<T, Task> action)
        {
            await action(self);
            return self;
        }
        ...
        /// <returns>Task of T type</returns>
        public static async Task<T> Do<T, TEx>(this T self, Func<T, Task<TEx>> action)
        {
            await action(self);
            return self;
        }
        ...
        /// <param name="action">Func with T arg, returns Task</param>
        /// <returns>Task of T type</returns>
        public static async Task<T> Do<T>(this Task<T> taskSelf, Func<T, Task> action)
        {
        ...
        /// <param name="action">Func with T arg, returns Task of TEx type</param>
        /// <returns>Task of T type</returns>
        public static async Task<T> Do<T, TEx>(this Task<T> taskSelf, Func<T, Task<TEx>> action)
        {
            var self = await taskSelf;
            await action(self);
            return self;
